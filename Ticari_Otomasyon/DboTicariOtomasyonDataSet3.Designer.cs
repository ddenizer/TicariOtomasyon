...
namespace Ticari_Otomasyon {
    ...
    public partial class DboTicariOtomasyonDataSet3 : global::System.Data.DataSet {
        ...
        public partial class TBL_MUSTERILERDataTable : global::System.Data.TypedTableBase<TBL_MUSTERILERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TBL_MUSTERILERRow AddTBL_MUSTERILERRow(string MUSTERIAD, string SOYAD, string TELEFON, string TELEFON2, string TC, string MAIL, string IL, string ILCE, string ADRES, string VERGIDAIRE) {
...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSet3TableAdapters {
    ...
    public partial class TBL_MUSTERILERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_MUSTERILER] ([MUSTERIAD], [SOYAD], [TELEFON], [TELEFON2], [TC], [MAIL], [IL], [ILCE], [ADRES], [VERGIDAIRE]) VALUES (@MUSTERIAD, @SOYAD, @TELEFON, @TELEFON2, @TC, @MAIL, @IL, @ILCE, @ADRES, @VERGIDAIRE);
SELECT ID, MUSTERIAD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES, VERGIDAIRE FROM TBL_MUSTERILER WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TBL_MUSTERILER] SET [MUSTERIAD] = @MUSTERIAD, [SOYAD] = @SOYAD, [TELEFON] = @TELEFON, [TELEFON2] = @TELEFON2, [TC] = @TC, [MAIL] = @MAIL, [IL] = @IL, [ILCE] = @ILCE, [ADRES] = @ADRES, [VERGIDAIRE] = @VERGIDAIRE WHERE (([ID] = @Original_ID) AND ((@IsNull_MUSTERIAD = 1 AND [MUSTERIAD] IS NULL) OR ([MUSTERIAD] = @Original_MUSTERIAD)) AND ((@IsNull_SOYAD = 1 AND [SOYAD] IS NULL) OR ([SOYAD] = @Original_SOYAD)) AND ((@IsNull_TELEFON = 1 AND [TELEFON] IS NULL) OR ([TELEFON] = @Original_TELEFON)) AND ((@IsNull_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND ((@IsNull_TC = 1 AND [TC] IS NULL) OR ([TC] = @Original_TC)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_ADRES = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_VERGIDAIRE = 1 AND [VERGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Original_VERGIDAIRE)));
SELECT ID, MUSTERIAD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES, VERGIDAIRE FROM TBL_MUSTERILER WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, MUSTERIAD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES, VERGID" +
                "AIRE FROM dbo.TBL_MUSTERILER";
        ...
        public virtual int Delete(int Original_ID, string Original_MUSTERIAD, string Original_SOYAD, string Original_TELEFON, string Original_TELEFON2, string Original_TC, string Original_MAIL, string Original_IL, string Original_ILCE, string Original_ADRES, string Original_VERGIDAIRE) {
        ...
        public virtual int Insert(string MUSTERIAD, string SOYAD, string TELEFON, string TELEFON2, string TC, string MAIL, string IL, string ILCE, string ADRES, string VERGIDAIRE) {
            if ((MUSTERIAD == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_ADRES, 
                    string Original_VERGIDAIRE) {
            return this.Update(MUSTERIAD, SOYAD, TELEFON, TELEFON2, TC, MAIL, IL, ILCE, ADRES, VERGIDAIRE, Original_ID, Original_MUSTERIAD, Original_SOYAD, Original_TELEFON, Original_TELEFON2, Original_TC, Original_MAIL, Original_IL, Original_ILCE, Original_ADRES, Original_VERGIDAIRE, Original_ID);
        }
    }
