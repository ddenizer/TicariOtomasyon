...
namespace Ticari_Otomasyon.DboTicariOtomasyonDataSet1TableAdapters {
    ...
    public partial class TBL_FIRMALARTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TBL_FIRMALAR] WHERE (([ID] = @Original_ID) AND ((@IsNull_FIRMA" +
                "AD = 1 AND [FIRMAAD] IS NULL) OR ([FIRMAAD] = @Original_FIRMAAD)) AND ((@IsNull_" +
                "YETKILISTATU = 1 AND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Original_YETK" +
                "ILISTATU)) AND ((@IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) OR ([Y" +
                "ETKILIADSOYAD] = @Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AND [YET" +
                "KILITC] IS NULL) OR ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_SEKTOR = " +
                "1 AND [SEKTOR] IS NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TELEFON1" +
                " = 1 AND [TELEFON1] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND ((@IsNull" +
                "_TELEFON2 = 1 AND [TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND " +
                "((@IsNull_TELEFON3 = 1 AND [TELEFON3] IS NULL) OR ([TELEFON3] = @Original_TELEFO" +
                "N3)) AND ((@IsNull_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AN" +
                "D ((@IsNull_FAX = 1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@IsNull" +
                "_IL = 1 AND [IL] IS NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [" +
                "ILCE] IS NULL) OR ([ILCE] = @Original_ILCE)) AND ((@IsNull_VERGIDAIRE = 1 AND [V" +
                "ERGIDAIRE] IS NULL) OR ([VERGIDAIRE] = @Original_VERGIDAIRE)) AND ((@IsNull_ADRE" +
                "S = 1 AND [ADRES] IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD" +
                "1 = 1 AND [OZELKOD1] IS NULL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNul" +
                "l_OZELKOD2 = 1 AND [OZELKOD2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND" +
                " ((@IsNull_OZELKOD3 = 1 AND [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELK" +
                "OD3)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TBL_FIRMALAR] ([FIRMAAD], [YETKILISTATU], [YETKILIADSOYAD], [YETKILITC], [SEKTOR], [TELEFON1], [TELEFON2], [TELEFON3], [MAIL], [FAX], [IL], [ILCE], [VERGIDAIRE], [ADRES], [OZELKOD1], [OZELKOD2], [OZELKOD3]) VALUES (@FIRMAAD, @YETKILISTATU, @YETKILIADSOYAD, @YETKILITC, @SEKTOR, @TELEFON1, @TELEFON2, @TELEFON3, @MAIL, @FAX, @IL, @ILCE, @VERGIDAIRE, @ADRES, @OZELKOD1, @OZELKOD2, @OZELKOD3);
SELECT ID, FIRMAAD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 FROM TBL_FIRMALAR WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TBL_FIRMALAR] SET [FIRMAAD] = @FIRMAAD, [YETKILISTATU] = @YETKILIST" +
                "ATU, [YETKILIADSOYAD] = @YETKILIADSOYAD, [YETKILITC] = @YETKILITC, [SEKTOR] = @S" +
                "EKTOR, [TELEFON1] = @TELEFON1, [TELEFON2] = @TELEFON2, [TELEFON3] = @TELEFON3, [" +
                "MAIL] = @MAIL, [FAX] = @FAX, [IL] = @IL, [ILCE] = @ILCE, [VERGIDAIRE] = @VERGIDA" +
                "IRE, [ADRES] = @ADRES, [OZELKOD1] = @OZELKOD1, [OZELKOD2] = @OZELKOD2, [OZELKOD3" +
                "] = @OZELKOD3 WHERE (([ID] = @Original_ID) AND ((@IsNull_FIRMAAD = 1 AND [FIRMAA" +
                "D] IS NULL) OR ([FIRMAAD] = @Original_FIRMAAD)) AND ((@IsNull_YETKILISTATU = 1 A" +
                "ND [YETKILISTATU] IS NULL) OR ([YETKILISTATU] = @Original_YETKILISTATU)) AND ((@" +
                "IsNull_YETKILIADSOYAD = 1 AND [YETKILIADSOYAD] IS NULL) OR ([YETKILIADSOYAD] = @" +
                "Original_YETKILIADSOYAD)) AND ((@IsNull_YETKILITC = 1 AND [YETKILITC] IS NULL) O" +
                "R ([YETKILITC] = @Original_YETKILITC)) AND ((@IsNull_SEKTOR = 1 AND [SEKTOR] IS " +
                "NULL) OR ([SEKTOR] = @Original_SEKTOR)) AND ((@IsNull_TELEFON1 = 1 AND [TELEFON1" +
                "] IS NULL) OR ([TELEFON1] = @Original_TELEFON1)) AND ((@IsNull_TELEFON2 = 1 AND " +
                "[TELEFON2] IS NULL) OR ([TELEFON2] = @Original_TELEFON2)) AND ((@IsNull_TELEFON3" +
                " = 1 AND [TELEFON3] IS NULL) OR ([TELEFON3] = @Original_TELEFON3)) AND ((@IsNull" +
                "_MAIL = 1 AND [MAIL] IS NULL) OR ([MAIL] = @Original_MAIL)) AND ((@IsNull_FAX = " +
                "1 AND [FAX] IS NULL) OR ([FAX] = @Original_FAX)) AND ((@IsNull_IL = 1 AND [IL] I" +
                "S NULL) OR ([IL] = @Original_IL)) AND ((@IsNull_ILCE = 1 AND [ILCE] IS NULL) OR " +
                "([ILCE] = @Original_ILCE)) AND ((@IsNull_VERGIDAIRE = 1 AND [VERGIDAIRE] IS NULL" +
                ") OR ([VERGIDAIRE] = @Original_VERGIDAIRE)) AND ((@IsNull_ADRES = 1 AND [ADRES] " +
                "IS NULL) OR ([ADRES] = @Original_ADRES)) AND ((@IsNull_OZELKOD1 = 1 AND [OZELKOD" +
                "1] IS NULL) OR ([OZELKOD1] = @Original_OZELKOD1)) AND ((@IsNull_OZELKOD2 = 1 AND" +
                " [OZELKOD2] IS NULL) OR ([OZELKOD2] = @Original_OZELKOD2)) AND ((@IsNull_OZELKOD" +
                "3 = 1 AND [OZELKOD3] IS NULL) OR ([OZELKOD3] = @Original_OZELKOD3)));\r\nSELECT ID" +
                ", FIRMAAD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, " +
                "TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3 F" +
                "ROM TBL_FIRMALAR WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FIRMAAD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TE" +
                "LEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZ" +
        ...
        public virtual int Update(
                    ...
                    string Original_OZELKOD2, 
                    string Original_OZELKOD3) {
            return this.Update(FIRMAAD, YETKILISTATU, YETKILIADSOYAD, YETKILITC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAIL, FAX, IL, ILCE, VERGIDAIRE, ADRES, OZELKOD1, OZELKOD2, OZELKOD3, Original_ID, Original_FIRMAAD, Original_YETKILISTATU, Original_YETKILIADSOYAD, Original_YETKILITC, Original_SEKTOR, Original_TELEFON1, Original_TELEFON2, Original_TELEFON3, Original_MAIL, Original_FAX, Original_IL, Original_ILCE, Original_VERGIDAIRE, Original_ADRES, Original_OZELKOD1, Original_OZELKOD2, Original_OZELKOD3, Original_ID);
        }
    }
